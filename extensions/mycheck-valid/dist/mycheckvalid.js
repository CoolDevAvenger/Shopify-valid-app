...
${errorInfo.componentStack}`);
  ...
  // extensions/mycheck-valid/src/Checkout.jsx
  ...
  function App() {
    const ageTarget = 18;
    const [address, setAddress] = (0, import_react15.useState)("");
    const [validationAddressError, setValidationAddressError] = (0, import_react15.useState)("");
    const [phoneNumber, setPhoneNumber] = (0, import_react15.useState)("");
    const [validationPhoneNumberError, setValidationPhoneNumberError] = (0, import_react15.useState)("");
    const [city, setCity] = (0, import_react15.useState)("");
    const [validationCityError, setValidationCityError] = (0, import_react15.useState)("");
    const [postalCode, setPostalCode] = (0, import_react15.useState)("");
    const [validationPostalCodeError, setValidationPostalCodeError] = (0, import_react15.useState)("");
    const handleVerifyPostalCode = () => __async(this, null, function* () {
      return yield (0, import_isomorphic_fetch.default)(`https://app.zipcodebase.com/api/v1/search?apikey=97af22b0-806c-11ee-ba55-1be5b36e30c5&codes=${postalCode}`).then((response) => {
        if (!response.ok) {
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      ...
      if (canBlockProgress2 && (!isAddressSet() || !isPhoneNumberValid() || !isCityValid())) {
        return {
          behavior: "block",
      ...
      if (canBlockProgress2 && !isAddressValid()) {
        return {
          behavior: "block",
          ...
          errors: [
            {
              ...
              message: "Please fill correct address."
            }
          ]
        };
      }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Phone" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        TextField2,
        {
          label: "Phone Number",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        Grid2,
        {
          ...
          spacing: "loose",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { border: "base", padding: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              TextField2,
              {
                label: "Postal Code",
                type: "number",
...
//# sourceMappingURL=mycheckvalid.js.map
